#include "stdafx.h"
#include "resource.h"
#include "Sid Meier's Alien Crossfire.h"

TCHAR *GAlienCrossfire::FactionNames[] = {L"The Green", L"The Despot", L"The Scientist", L"The Mogul", L"The Survivalist", L"The Fundamentalist", L"The Humanitarian", L"The Algorithm", L"The Buccaneer", L"The Laborer", L"The Infogrrrrl", L"The Voice", L"The Conservator", L"The Insurgent"};

const int GAlienCrossfire::NUM_MAP_TYPES = 4;
TCHAR *GAlienCrossfire::MapTypeNames[] = {L"Make Random Map", L"Customize Random Map", L"The Map of Planet", L"Huge Map of Planet"};

const int GAlienCrossfire::NUM_DIFFICULTIES = 6;
TCHAR *GAlienCrossfire::DifficultyNames[] = {L"Citizen", L"Specialist", L"Talent", L"Librarian", L"Thinker", L"Transcend"};

const int GAlienCrossfire::NUM_PLANET_SIZES = 6;
TCHAR *GAlienCrossfire::PlanetSizeNames[] = {L"Tiny Planet", L"Small Planet", L"Standard Planet", L"Large Planet", L"Huge Planet", L"Custom Size"};

const int GAlienCrossfire::NUM_GAME_RULES_MENU_ITEMS = 3;
TCHAR *GAlienCrossfire::GameRulesMenuNames[] = {L"Play with Standard Rules", L"Play with Current Rules", L"Customize Rules"};

const int GAlienCrossfire::NUM_OCEAN_COVERAGES = 3;
TCHAR *GAlienCrossfire::OceanCoverageNames[] = {L"30-50% of Surface", L"50-70% of Surface", L"70-90% of Surface"};

const int GAlienCrossfire::NUM_EROSIVE_FORCES = 3;
TCHAR *GAlienCrossfire::ErosiveForcesNames[] = {L"Strong", L"Average", L"Weak"};

const int GAlienCrossfire::NUM_NATIVE_LIFE_FORMS = 3;
TCHAR *GAlienCrossfire::NativeLifeFormNames[] = {L"Rare", L"Average", L"Abundant"};

const int GAlienCrossfire::NUM_CLOUD_COVERS = 3;
TCHAR *GAlienCrossfire::CloudCoverNames[] = {L"Sparse", L"Average", L"Dense"};

const int GAlienCrossfire::NUM_CUSTOM_RULES = 18;
TCHAR *GAlienCrossfire::CustomRuleNames[] = {
...
BOOL GAlienCrossfire::CustomRuleDefaults[] = {TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE};

GAlienCrossfireTeam GAlienCrossfire::FactionDefaults[] = {
	GAlienCrossfireTeam(L"Deirdre", L"Gaia's Stepdaughters", L"Gaians", L"Gaian", L"Lady", L"beautiful", L"Female"),
	GAlienCrossfireTeam(L"Yang", L"Human Hive", L"Hive", L"Hive", L"Chairman", L"ruthless", L"Male"),
	GAlienCrossfireTeam(L"Zakharov", L"University of Planet", L"University", L"University", L"Provost", L"brilliant", L"Male"),
	GAlienCrossfireTeam(L"Morgan", L"Morgan Industries", L"Morganites", L"Morganic", L"CEO", L"shrewd", L"Male"),
	GAlienCrossfireTeam(L"Santiago", L"Spartan Federation", L"Spartans", L"Spartan", L"Colonel", L"vigilant", L"Female"),
	GAlienCrossfireTeam(L"Miriam", L"The Lord's Believers", L"Believers", L"Believing", L"Sister", L"pious", L"Female"),
	GAlienCrossfireTeam(L"Lal", L"Peacekeeping Forces", L"Peacekeepers", L"Peacekeeper", L"Brother", L"humane", L"Male"),
	GAlienCrossfireTeam(L"Aki Zeta-5", L"The Cybernetic Consciousness", L"Consciousness", L"Cybernetic", L"Prime Function", L"analytical", L"Female"),
	GAlienCrossfireTeam(L"Svensgaard", L"Nautilus Pirates", L"Pirates", L"Nautilus", L"Captain", L"heroic", L"Male"),
	GAlienCrossfireTeam(L"Domai", L"The Free Drones", L"Drones", L"Free Drone", L"Foreman", L"stalwart", L"Male"),
	GAlienCrossfireTeam(L"Roze", L"The Data Angels", L"Angels", L"Datatech", L"Datajack", L"stylish", L"Female"),
	GAlienCrossfireTeam(L"Cha Dawn", L"The Cult of Planet", L"Planet Cult", L"Cultist", L"Prophet", L"charismatic", L"Male"),
	GAlienCrossfireTeam(L"H'minee", L"Manifold Caretakers", L"Caretakers", L"Caretaker", L"Guardian", L"insightful", L"Female"),
	GAlienCrossfireTeam(L"Marr", L"Manifold Usurpers", L"Usurpers", L"Usurper", L"Conqueror", L"mighty", L"Male")
};

PLUGINS_API GlobalGameSettings *CreatePlugin()
{
	return new GGAlienCrossfireSettings();
}
...
SessionInfo *GGAlienCrossfireSettings::AllocSession()
{
	return (SessionInfo *)new GAlienCrossfire(this);
}

void GGAlienCrossfireSettings::CloseGameWindow(HWND hWnd)
{
...
INT_PTR CALLBACK GAlienCrossfire::TeamSettingsDialogProc(HWND hDialog, UINT message, WPARAM wParam, LPARAM lParam)
{
	static GAlienCrossfire *session;
	static GAlienCrossfireTeam *team;
	int factionNum;
	...
	{
	case WM_INITDIALOG:
		session = (GAlienCrossfire *)lParam;
...
BOOL GAlienCrossfire::ValidateTeamSettings(Team *team, int type, int sIndex, int tIndex)
{
	GAlienCrossfireTeam *pTeam = (GAlienCrossfireTeam *)team;
...
DLGPROC GAlienCrossfire::GetTeamSettingsDialogProc()
{
	return TeamSettingsDialogProc;
}

GAlienCrossfireTeam *GAlienCrossfire::AllocTeam()
{
	GAlienCrossfireTeam *team;

	team = new GAlienCrossfireTeam();

	return team;
}

BOOL GAlienCrossfire::NewGame()
{
	int yPos, teamNum = 0;
	TCHAR customMapSize[9];
	GAlienCrossfireSettings *gSettings = (GAlienCrossfireSettings *)&(this->gameSettings); 
	GAlienCrossfireTeam *team;
	LinkedList *iter;
	GGAlienCrossfireSettings *gg = (GGAlienCrossfireSettings *)ggSettings;
	...
	{
		iter = iter->next;
		team = (GAlienCrossfireTeam *)iter->item;

		// Press Arrow button
		ResetMouse();
		yPos = 15 * teamNum;
		MoveMouseMod(622, 119 + yPos);
		PressLButton();
		// Select faction from list
		for(int i = 0; i < (int)team->faction + 1; i++)
			PressKey(VK_DOWN);
		SleepC(250);
		PressKey(VK_RETURN);

		// Press 'Change Name'
		MoveMouseMod(-380, 15 * (6 - teamNum) + 21);
		PressLButton();

		// Press 'Restore Defaults'
		MoveMouseMod(120, 362);
		PressLButton();
		...
		if(teamNum == this->numPlayers - 1 && this->numPlayers < this->MAX_TEAMS)
		{
			// Press Arrow button
			ResetMouse();
			yPos = 15 * this->numPlayers;
			MoveMouseMod(622, 119 + yPos);
			for(int i = 0; i < MAX_TEAMS - this->numPlayers; i++)
			{
				PressLButton();
				// Select RANDOM from list
				for(int j = 0; j < this->NUM_FACTIONS + 1; j++)
					PressKey(VK_DOWN);
				SleepC(250);
				PressKey(VK_RETURN);
				MoveMouseMod(0, 15);
			...
			// Select last player
			ResetMouse();
			MoveMouseMod(550, 119 + (15 * teamNum));
			PressLButton();
		}
	...
	switch(message)
	{
		...
		case WM_COMMAND:
			if(LOWORD(wParam) == IDC_BROWSE_MAP_FILE_BUTTON)
			{
				...
				DialogBoxParam(session->ggSettings->hModule, MAKEINTRESOURCE(IDD_CUSTOMIZE_RULES), hDialog, GAlienCrossfire::CustomizeRulesDialogProc, (LPARAM)session);
			else if(HIWORD(wParam) == CBN_SELCHANGE || HIWORD(wParam) == BN_CLICKED) 
				GAlienCrossfire::UpdateGameSettingsDialog(hDialog);
			break;
		default:
			break;
	}
...
INT_PTR CALLBACK GAlienCrossfire::CustomizeRulesDialogProc(HWND hDialog, UINT message, WPARAM wParam, LPARAM lParam)
{
	static GAlienCrossfire *session;
	BOOL attrChecked;
...
void GAlienCrossfire::InitGameSettingsDialog()
{
	GAlienCrossfireSettings *game;
...
void GAlienCrossfire::UpdateGameSettingsDialog(HWND hGameDlg)
{
	BOOL bEnable;
	int show;
...
BOOL GAlienCrossfire::ParseGameSettingsDialog()
{
	GAlienCrossfireSettings *game = &this->gameSettings;
...
BOOL GAlienCrossfire::ValidateGameSettings(BOOL type, int sIndex)
{
	TCHAR cfgError[MBBUFFER_SIZE];
	GAlienCrossfireSettings *game = &this->gameSettings;
	HWND hWnd = NULL;
...
void GAlienCrossfire::InitGameSettings()
{
	memset(&gameSettings, 0, sizeof(GAlienCrossfireSettings));
...
void GAlienCrossfire::SaveGameSettings(config_setting_t *group)
{
...
void GAlienCrossfire::LoadGameSettings(config_setting_t *group)
{
...
void GAlienCrossfire::BuildEmailGameSettings(config_setting_t *group)
{
	cfgSetInt(group, L"map_type", this->gameSettings.mapType);
	cfgSetInt(group, L"difficulty", this->gameSettings.difficulty);
	cfgSetInt(group, L"planet_size", this->gameSettings.planetSize);
...
void GAlienCrossfire::ParseEmailGameSettings(config_setting_t *group)
{
	this->gameSettings.mapType = cfgGetInt(group, L"map_type");
	this->gameSettings.difficulty = cfgGetInt(group, L"difficulty");
	this->gameSettings.planetSize = cfgGetInt(group, L"planet_size");
...
void GAlienCrossfire::UpdateEmailGameSettings(SessionInfo *in)
{
	GAlienCrossfire *pIn = (GAlienCrossfire *)in;
	memcpy(&(this->gameSettings), &(pIn->gameSettings), sizeof(GAlienCrossfireSettings));
}

void GAlienCrossfire::SaveTeamSettings(config_setting_t *group, Team *team)
{
	GAlienCrossfireTeam *pTeam = (GAlienCrossfireTeam *)team; 
...
void GAlienCrossfire::LoadTeamSettings(config_setting_t *group, Team *team)
{
	GAlienCrossfireTeam *pTeam = (GAlienCrossfireTeam *)team; 
...
void GAlienCrossfire::BuildEmailTeamSettings(config_setting_t *group, Team *team)
{
	GAlienCrossfireTeam *pTeam = (GAlienCrossfireTeam *)team; 
...
void GAlienCrossfire::ParseEmailTeamSettings(config_setting_t *group, Team *team)
{
	GAlienCrossfireTeam *pTeam = (GAlienCrossfireTeam *)team; 
...
void GAlienCrossfire::UpdateEmailTeamSettings(Team *out, Team *in)
{
	GAlienCrossfireTeam *pOut = (GAlienCrossfireTeam *)out; 
	GAlienCrossfireTeam *pIn = (GAlienCrossfireTeam *)in;
...
TCHAR *GAlienCrossfire::GetSaveFileName(TCHAR *name)
{
...
TCHAR *GAlienCrossfire::GetSaveFolderPath()
{
